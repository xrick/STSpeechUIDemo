        ...
        case Message_Type_Template:
        {
            ...
            switch (_contentItem.message.attachment.payload.template_type) {
                ...
                case Template_Type_CI_Confirm_Booking:
                {
                    ...
                    contentSize = CGSizeMake(screenW - contentX - ChatContentLeft - ChatContentRight, 280);
                    ...
                    _contentF = CGRectMake(DEFAULT_CI_BASE_CELL_FRAME_ORIGIN_X, DEFAULT_CI_BASE_CELL_FRAME_ORIGIN_Y, DEFAULT_CI_BASE_CELL_WIDTH, DEFAULT_CI_BASE_CELL_HEIGHT);
                    _cellHeight = MAX(CGRectGetMaxY(_contentF), CGRectGetMaxY(_nameF))  + ChatMargin;
                }
                    break;
...
//                    _cellHeight = MAX(CGRectGetMaxY(_contentF), CGRectGetMaxY(_nameF))  + ChatMargin;
    ...
    //以下二行碼從上面移下來，做測試用
//    {
//        CGFloat height =  280;//imageHeight + titleHeight + subtitleHeight + buttonTotalHeight;
//        contentSize = CGSizeMake(screenW - contentX - ChatContentLeft - ChatContentRight, height);
//    }
