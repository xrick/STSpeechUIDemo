...
- (id)initWithSuperVC:(UIViewController *)superVC {
    ...
    if (self) {
        ...
        //分割线 (xrickliao: spliter line setting is here)
        self.layer.borderWidth = 1;
        self.layer.borderColor = [[UIColor lightGrayColor] colorWithAlphaComponent:0.3].CGColor;
        //self.layer.borderColor = [[UIColor redColor] colorWithAlphaComponent:0.3].CGColor;
...
- (UIButton *)getSpeakButton {
    if (!_speakButton) {
        ...
        _speakButton.center = CGPointMake(self.center.x, INPUTFUNCTIONVIEW_TEXTBAR_HEIGHT + (INPUTFUNCTIONVIEW_SPEAK_HEIGHT - INPUTFUNCTIONVIEW_TEXTBAR_HEIGHT)*0.5-20);
...
- (UITextView *)getTextViewInput {
    if (!_textViewInput) {
        ...
        UITextView *textView = [[UITextView alloc]initWithFrame:CGRectMake(45, 7, Main_Screen_Width-2*45, 30)];
