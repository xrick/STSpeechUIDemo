...
- (void)viewDidLoad {
    ...
    self.title = IQLocalizedString(@"更多", nil); //original : 設定
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        */
        ...
        cell.textLabel.text = IQLocalizedString(@"意見回饋", nil);
        cell.tag = TAG_FEEDBACK;
        UIImageView * imgView = [[UIImageView alloc]init];
        imgView.frame = CGRectMake(cell.contentView.frame.size.width+16, 16, 16, 16);
        [imgView setImage:[UIImage imageNamed:@"Back_Right"]];
