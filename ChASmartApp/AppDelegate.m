...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    CILoginControllerViewController * loginController = [[CILoginControllerViewController alloc]initWithFrame:[UIScreen mainScreen].bounds];
    //loginController.view.backgroundColor = [UIColor whiteColor];
    nav.navigationBar.hidden = true;
    [nav pushViewController:loginController animated:false];
